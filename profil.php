...
<div class="profil">
    ...
    <div class="header-profil">
        ...
        <div class="gauche">
            ...
            <img src="https://images.unsplash.com/photo-1704726135027-9c6f034cfa41?crop=entropy&amp;cs=tinysrgb&amp;fit=max&amp;fm=jpg&amp;ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx1c2VyJTIwcHJvZmlsZSUyMGF2YXRhcnxlbnwxfHx8fDE3NjU5NTE2MDN8MA&amp;ixlib=rb-4.1.0&amp;q=80&amp;w=1080"
        ...
        <div class="droite">
            ...
            <div class="svg-container">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"
                    ...
                    class="lucide lucide-user text-blue-600" aria-hidden="true">
    ...
    <div class="main-profil">
        ...
        <div class="title">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-calculator text-blue-600" aria-hidden="true">
        ...
        <div class="stat">
            ...
            <h1><?php if (isset($_SESSION["totalOperation"])):
                echo $_SESSION["totalOperation"];
            else: ?>0<?php endif; ?></h1>

            <p> Vous avez effectué <span style="color: blue;"><?php if (isset($_SESSION["totalOperation"])):
                echo $_SESSION["totalOperation"];
            else: ?>0<?php endif; ?></span> opérations
                mathématiques au total </p>
    ...
    <div class="footer-profil">
        ...
        <div class="no-operation" <?php if (isset($_SESSION["operation"])): ?> style="display: none;" <?php endif; ?>>
            ...
            <p> Vous n'avez pas encore effectué de convertion. Utilisez la calculatrice pour commencer ! </p>
        ...
        <div class="operation" <?php if (!isset($_SESSION["operation"])): ?> style="display: none;" <?php endif; ?>>
            ...
            <div class="last-ope" <?php if (!isset($_SESSION["operation"])): ?> style="display: none;" <?php endif; ?>>
                ...
                <div class="last addition" <?php if (empty(lastOperation("addition"))): ?> style="display: none;" <?php endif; ?>>
                    ...
                    <p><?php echo $tabAddition["nb1"] . " + " . $tabAddition["nb2"] . " = "; ?><span
                            style="color: var(--color-addition);"><?php echo $tabAddition["resultat"]; ?></span></p>

                </div>

                <div class="last soustraction" <?php if (empty(lastOperation("soustraction"))): ?>
                        style="display: none;" <?php endif; ?>>

                    <p class="gris"> Dernière soustraction </p>
                    <?php $tabSoustraction = lastOperation("soustraction"); ?>

                    <p><?php echo $tabSoustraction["nb1"] . " - " . $tabSoustraction["nb2"] . " = "; ?><span
                            style="color: var(--color-soustraction);"><?php echo $tabSoustraction["resultat"]; ?></span>
                    </p>


                </div>

                <div class="last multiplication" <?php if (empty(lastOperation("multiplication"))): ?>
                        style="display: none;" <?php endif; ?>>

                    <p class="gris"> Dernière multiplication </p>
                    <?php $tabMultiplication = lastOperation("multiplication"); ?>

                    <p><?php echo $tabMultiplication["nb1"] . " x " . $tabMultiplication["nb2"] . " = "; ?><span
                            style="color: var(--color-multiplication);"><?php echo $tabMultiplication["resultat"]; ?></span>
                    </p>
                ...
                <div class="last division" <?php if (empty(lastOperation("division"))): ?> style="display: none;" <?php endif; ?>>
                    ...
                    <p><?php echo $tabDivision["nb1"] . " / " . $tabDivision["nb2"] . " = "; ?><span
                            style="color: var(--color-division);"><?php echo $tabDivision["resultat"]; ?></span></p>
            ...
            <div class="history" <?php if (!isset($_SESSION["operation"])): ?> style="display: none;" <?php endif; ?>>
                ...
                foreach ($_SESSION["operation"] as $operation):
                    ...
                    <div class="history-ope <?php echo $type; ?>">
                        ...
                        <p class="ope"
                            style="color: var(--color-<?php echo $type; ?>);background-color: var(--back-color-<?php echo $type; ?>)">
                            <?php echo strtoupper($type); ?></p>
